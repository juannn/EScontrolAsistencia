...
public class BaseDeDatos extends SQLiteOpenHelper {
	...
	public BaseDeDatos(Context context) {
		super(context, "Sabatica.db",null,1);
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE Personal (_id INTEGER PRIMARY KEY AUTOINCREMENT,NombreUsuario TEXT, Password TEXT,Nombre TEXT,Apellido TEXT,FechaNacimiento TEXT,FechaRegistro TEXT,Contacto INTEGER,Domicilio TEXT,Descripcion TEXT,idRoles INTEGER);");
			
		db.execSQL("CREATE TABLE Clase (_id INTEGER PRIMARY KEY AUTOINCREMENT,NombreClase TEXT,idPersonal INTEGER);");
		
		db.execSQL("CREATE TABLE Miembros (_id INTEGER PRIMARY KEY AUTOINCREMENT,Nombres TEXT,Apellidos TEXT,FechaNacimiento TEXT,FechaRegistro TEXT,Contacto INTEGER,Domicilio TEXT,Descripcion TEXT,idClase INTEGER);");
		
		db.execSQL("CREATE TABLE Llegadas (_id INTEGER PRIMARY KEY AUTOINCREMENT,Hora TEXT, Fecha TEXT,idMiembros INTEGER);");
